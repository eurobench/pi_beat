...
file_id=fopen(strcat(pwd,"/", name2, "_OS", ".yaml"),'w'); %%open file to write into
...
file_id=fopen(strcat(pwd,"/", name2, "_THETA_F", ".yaml"),'w'); %%open file to write into
fprintf(file_id, "type: 'vector' 'measure unit: °\' \n");
label_str="direction: [";
for i=1:length(direction)
  label_str=sprintf("%s",label_str,char(direction(i)));
...
file_id=fopen(strcat(pwd,"/", name2, "_DELTA_THETA", ".yaml"),'w'); %%open file to write into
fprintf(file_id, "type: 'vector' 'measure unit: °\' \n");
label_str="direction: [";
for i=1:length(direction)
  label_str=sprintf("%s",label_str,char(direction(i)));
